...
public class Iterators {
	...
	public static class IteratorIterator<T> implements Iterator<T> {
		...
		Iterator keys;
		org.arbiter.berkeley.Factory<Iterator<T>> iterFactory;

		public IteratorIterator(Iterator keys, org.arbiter.berkeley.Factory<Iterator<T>> iterFactory) {
			this.keys = keys;
	...
	public static <T> Iterator<T> concat(Iterable<Iterator<? extends T>> args) {
		org.arbiter.berkeley.Factory<Iterator<T>> factory = new org.arbiter.berkeley.Factory<Iterator<T>>() {
