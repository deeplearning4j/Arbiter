...
public class MathUtils  {
    ...
    public static double permutation(double n,double r) {
        double nFac= org.deeplearning4j.util.MathUtils.factorial(n);
        double nMinusRFac= org.deeplearning4j.util.MathUtils.factorial((n - r));
    ...
    public static double combination(double n,double r) {
        double nFac= org.deeplearning4j.util.MathUtils.factorial(n);
        double rFac= org.deeplearning4j.util.MathUtils.factorial(r);
        double nMinusRFac= org.deeplearning4j.util.MathUtils.factorial((n - r));
    ...
    public static double bernoullis(double n,double k,double successProb) {
        ...
        double combo = org.deeplearning4j.util.MathUtils.combination(n, k);
