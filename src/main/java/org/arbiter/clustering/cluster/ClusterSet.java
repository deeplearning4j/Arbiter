...
public class ClusterSet {
	...
	public PointClassification classifyPoint(Point point, boolean moveClusterCenter) {
		org.arbiter.berkeley.Pair<Cluster, Double> nearestCluster = nearestCluster(point);
	...
	public org.arbiter.berkeley.Pair<Cluster, Double> nearestCluster(Point point) {
		...
		return new org.arbiter.berkeley.Pair<Cluster, Double>(nearestCluster, minDistance);
